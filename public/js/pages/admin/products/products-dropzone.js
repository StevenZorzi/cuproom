...
$("form#img-upload").dropzone({
    ...
    init:function() {
        ...
        $.get(url['get_img'], function(data) {
            ...
            $.each(data.images, function (key, value) {
                ...
                myDropzone.createThumbnailFromUrl(file, url['path_products_img'] + "/thumb-" + value.server );
        ...
        this.on("removedfile", function(file) {
            $.ajax({
                ...
                success: function(data){
                    success('img-delete');
                    if($('form#img-upload .dropzone-previews .dz-preview').length > 0){
    ...
    success: function(file,done) {
        ...
        if($('form#img-upload .dropzone-previews .dz-preview').length < 2){
            $(".panel.preview img").attr('src', url['path_products_img']+"/"+done.filename);
        ...
        $.get(url['get_fls'], function(data) {
            ...
            $.each(data.images, function (key, value) {
                ...
                if(ext == 'png' || ext == 'jpg' || ext == 'jpeg' || ext == 'gif')
                    myDropzone.createThumbnailFromUrl(file, url['path_products_img'] + "/" + value.server );
                else
