...
Dropzone.options.realDropzone = {
    ...
    init:function() {
        ...
        $.get(url['get_img'], function(data) {
            ...
            $.each(data.images, function (key, value) {
                ...
                myDropzone.createThumbnailFromUrl(file, url['path_users_img'] + "/thumb-" + value.server );
            ...
            if(i>0){
                ...
                $("form.dropzone").addClass("file-upload");
        ...
        this.on("addedfile", function(file) {
            $("form.dropzone").removeClass("file-upload");
    ...
    success: function(file,done) {
        ...
        if($('.dropzone-previews .dz-preview').length < 2){
            $(".panel.preview img").attr('src', url['path_users_img']+"/"+done.filename);
