...
Dropzone.options.realDropzone = {
    ...
    dictMaxFilesExceeded: 'Hai raggiunto il limite massimo di immagini.',
    thumbnailWidth: null,
    ...
    init:function() {
        ...
        $.get(url['get_img'], function(data) {
            ...
            $.each(data.images, function (key, value) {
                ...
                myDropzone.createThumbnailFromUrl(file, url['path_gallery_img'] + "/thumb-" + value.server );
    ...
    success: function(file,done) {
        ...
        if($('.dropzone-previews .dz-preview').length < 2){
            $(".panel.preview img").attr('src', url['path_gallery_img']+"/"+done.filename);
